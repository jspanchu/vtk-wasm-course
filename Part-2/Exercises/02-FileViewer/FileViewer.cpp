/** EXERCISE: Bind the FileViewer class and its methods using Emscripten's embind.
 *  HINT: Refer to the embind documentation for guidance: https://emscripten.org/docs/porting/connecting_cpp_and_javascript/embind.html#classes
 */
#include <vtkActor.h>
...
EMSCRIPTEN_BINDINGS(FileViewerModule) {
  // TODO: Bind the FileViewer class and its methods here
}
